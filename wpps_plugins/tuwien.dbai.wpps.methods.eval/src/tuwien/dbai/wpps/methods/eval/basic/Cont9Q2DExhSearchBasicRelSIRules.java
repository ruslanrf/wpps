 ...
 */
public class Cont9Q2DExhSearchBasicRelSIRules extends AWPUWrapper {
	private static final Logger log = Logger.getLogger(Cont9Q2DExhSearchBasicRelSIRules.class);

private static final String filePath = "/home/ruslan/tmp/eval/Cont9Q2DExhSearchBasicRelSIRules_.csv";
	
	/**
	 * @param description
	 */
	public Cont9Q2DExhSearchBasicRelSIRules(AWPUMethodDescription description) {
		super(description);
	}
