 ...
 */
public class Cont4CExhSearchCompRel extends AWPUWrapper {
	private static final Logger log = Logger.getLogger(Cont4CExhSearchCompRel.class);
	
private static final String filePath = "/home/ruslan/tmp/eval/Cont4CExhSearchCompRel.csv";

	/**
	 * @param description
	 */
	public Cont4CExhSearchCompRel(AWPUMethodDescription description) {
		super(description);
	}
