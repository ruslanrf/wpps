 ...
 */
public class Cont8DExhSearchBasicRel extends AWPUWrapper {
	private static final Logger log = Logger.getLogger(Cont8DExhSearchBasicRel.class);

private static final String filePath = "/home/ruslan/tmp/eval/Cont8DExhSearchBasicRel.csv";
	
	/**
	 * @param description
	 */
	public Cont8DExhSearchBasicRel(AWPUMethodDescription description) {
		super(description);
	}
