 ...
 */
public class Cont2BExhSearchQntRel extends AWPUWrapper {
	private static final Logger log = Logger.getLogger(Cont2BExhSearchQntRel.class);
	
private static final String filePath = "/home/ruslan/tmp/eval/Cont2BExhSearchQntRel.csv";
	
	/**
	 * @param description
	 */
	public Cont2BExhSearchQntRel(AWPUMethodDescription description) {
		super(description);
	}
