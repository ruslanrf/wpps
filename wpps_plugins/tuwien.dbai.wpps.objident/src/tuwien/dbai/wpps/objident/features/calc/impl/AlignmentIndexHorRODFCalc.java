...
import tuwien.dbai.wpps.objident.features.descr.AlignmentIndexHorRODFDesc;
 ...
 * @created Sep 18, 2012 12:21:17 PM
 */
@Singleton
public class AlignmentIndexHorRODFCalc extends AFeatureCalculator {
	 ...
	 */
	@Inject
	public AlignmentIndexHorRODFCalc(
			AlignmentIndexHorRODFDesc featureDescription
			, IIEBasisAPI api) {
