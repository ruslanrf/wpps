...
import tuwien.dbai.wpps.objident.features.descr.LeftTxtOfOrthVisibleObjsROCFDesc;
 ...
 * @created Nov 4, 2012 5:22:04 PM
 */
public class LeftTxtOfOrthVisibleObjsROCFCalc extends AFeatureCalculator {
	
	private final IIEBasisAPI api;
	private final ObjidentConfig config;
	
	@Inject
	public LeftTxtOfOrthVisibleObjsROCFCalc(
			LeftTxtOfOrthVisibleObjsROCFDesc featureDescription
