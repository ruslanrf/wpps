 ...
 */
public class Cont9DExhSearchBasicRelSIRules extends AWPUWrapper {
	private static final Logger log = Logger.getLogger(Cont9DExhSearchBasicRelSIRules.class);

private static final String filePath = "/home/ruslan/tmp/eval/Cont9DExhSearchBasicRelSIRules_.csv";
	
	/**
	 * @param description
	 */
	public Cont9DExhSearchBasicRelSIRules(AWPUMethodDescription description) {
		super(description);
	}
