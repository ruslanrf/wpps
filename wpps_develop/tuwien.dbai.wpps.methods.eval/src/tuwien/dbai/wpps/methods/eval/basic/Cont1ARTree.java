 ...
 */
public class Cont1ARTree extends AWPUWrapper {
	private static final Logger log = Logger.getLogger(Cont1ARTree.class);
	
private static final String filePath = "/home/ruslan/tmp/eval/Cont1ARTree.csv";
	
	/**
	 * @param description
	 */
	public Cont1ARTree(AWPUMethodDescription description) {
		super(description);
	}
