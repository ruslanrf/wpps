 ...
 */
public class Cont5CQueryBasicRel extends AWPUWrapper {
	private static final Logger log = Logger.getLogger(Cont5CQueryBasicRel.class);

private static final String filePath = "/home/ruslan/tmp/eval/Cont5CQueryBasicRel.csv";
	
	/**
	 * @param description
	 */
	public Cont5CQueryBasicRel(AWPUMethodDescription description) {
		super(description);
	}
