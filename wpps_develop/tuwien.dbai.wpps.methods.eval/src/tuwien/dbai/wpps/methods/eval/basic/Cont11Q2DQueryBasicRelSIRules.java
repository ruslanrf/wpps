 ...
 */
public class Cont11Q2DQueryBasicRelSIRules extends AWPUWrapper {
	private static final Logger log = Logger.getLogger(Cont11Q2DQueryBasicRelSIRules.class);
	
private static final String filePath = "/home/ruslan/tmp/eval/Cont11Q2DQueryBasicRelSIRules.csv";

	/**
	 * @param description
	 */
	public Cont11Q2DQueryBasicRelSIRules(AWPUMethodDescription description) {
		super(description);
	}
