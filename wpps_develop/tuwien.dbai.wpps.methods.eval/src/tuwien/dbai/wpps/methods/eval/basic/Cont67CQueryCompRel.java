 ...
 */
public class Cont67CQueryCompRel extends AWPUWrapper {
	private static final Logger log = Logger.getLogger(Cont67CQueryCompRel.class);
	
private static final String filePath = "/home/ruslan/tmp/eval/Cont7CQueryCompRel.csv"; // TODO modify

	/**
	 * @param description
	 */
	public Cont67CQueryCompRel(AWPUMethodDescription description) {
		super(description);
	}
