 ...
 * @created Oct 5, 2012 7:09:37 PM
 */
public class RdfIMRadioButtonGroup extends RdfInstanceAdp implements IIMRadioButtonGroup {
	 ...
	 */
	@Inject
	public RdfIMRadioButtonGroup(@Assisted Resource inst,
//			@AnnotStructBlockGeomModel Model rdfModel,
	...
	@Override
	public Collection<IIMRadioButton> getRadioButtons() {
		return InstAdpLibSupport.convertResourceCollectionToInstAdpCollection(
				imImpl.getContainedIMRadioButton(rdfInst)
				, rdfInstAdpFactoryWrap
				, IIMRadioButton.class);
	}
