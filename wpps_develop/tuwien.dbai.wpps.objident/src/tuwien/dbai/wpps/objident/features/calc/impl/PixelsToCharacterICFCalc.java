...
import tuwien.dbai.wpps.objident.features.descr.PixelsToCharacterICFDesc;
 ...
 * @created Sep 21, 2012 11:55:25 PM
 */
@Singleton
public class PixelsToCharacterICFCalc extends AFeatureCalculator {

	@Inject
	protected PixelsToCharacterICFCalc(
			PixelsToCharacterICFDesc featureDescription) {
