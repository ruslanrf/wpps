...
import tuwien.dbai.wpps.objident.features.descr.UpperTxtOfOrthVisibleObjsROCFDesc;
 ...
 * @created Oct 23, 2012 8:35:55 PM
 */
@Singleton
public class UpperTxtOfOrthVisibleObjsROCFCalc extends AFeatureCalculator {
	
	private final IIEBasisAPI api;
	private final ObjidentConfig config;
	
	@Inject
	public UpperTxtOfOrthVisibleObjsROCFCalc(
			UpperTxtOfOrthVisibleObjsROCFDesc featureDescription
