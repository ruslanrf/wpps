...
import tuwien.dbai.wpps.objident.features.descr.AlignmentIndexVertROCFDesc;
 ...
 * @created Oct 24, 2012 3:45:05 PM
 */
@Singleton
public class AlignmentIndexVertROCFCalc extends AFeatureCalculator {
	 ...
	 */
	@Inject
	public AlignmentIndexVertROCFCalc(
			AlignmentIndexVertROCFDesc featureDescription
			, IIEBasisAPI api) {
