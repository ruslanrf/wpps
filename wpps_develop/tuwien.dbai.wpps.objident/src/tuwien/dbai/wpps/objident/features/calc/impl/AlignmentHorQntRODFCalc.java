...
import tuwien.dbai.wpps.objident.features.descr.AlignmentHorQntRODFDesc;
 ...
 * @created Sep 18, 2012 1:07:10 AM
 */
@Singleton
public class AlignmentHorQntRODFCalc extends AFeatureCalculator {
...
private final IIEBasisAPI api;
	 ...
	 */
	@Inject
	public AlignmentHorQntRODFCalc(
			final AlignmentHorQntRODFDesc featureDescription
